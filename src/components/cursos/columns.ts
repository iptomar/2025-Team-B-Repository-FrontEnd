...
export const columns: ColumnDef<Curso>[] = [
  {
    ...
    cell: ({ row }) => h('div', { class: 'ml-2 text-left font-semibold' }, row.getValue('curso')),
  },
  {
  ...
  },
  {
    ...
    header: () => h('div', { class: 'font-semibold' }, 'Professor Responsável'),
    cell: ({ row }) => h('div', { class: 'text-left' }, row.getValue('respProf')),
  },
  {
    id: 'actions',
    enableHiding: false,
