...
<template>
  <div class="flex flex-col h-full w-full">
    <div class="flex items-center pb-4 w-full space-x-4">
      <div class="flex-1">
        <Input class="w-full h-[2.7rem]" placeholder="Procurar por grau..."
    ...
    <Dialog v-model:open="showAddModal">
      <DialogContent class="w-full max-w-md">
        <DialogHeader>
          <DialogTitle>Adicionar Grau Académico</DialogTitle>
          <DialogDescription>
            Insira um novo grau Académico e clique em "Adicionar".
          </DialogDescription>
        </DialogHeader>
